...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center space-x-8">
      ...
      <Link to="/new-arrivals" className="text-gray-300 hover:text-white hover:scale-105 transform transition-all duration-200 text-sm uppercase tracking-wide font-medium">
        New Arrivals
      </Link>
